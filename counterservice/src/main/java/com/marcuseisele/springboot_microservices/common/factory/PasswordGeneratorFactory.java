package com.server.datn.server.common.factory;
...
public final class PasswordGeneratorFactory {
    ...
    private PasswordGeneratorFactory(PasswordGeneratorBuilder builder) {
    ...
    public static class PasswordGeneratorBuilder {
        ...
        public PasswordGeneratorFactory build() {
            return new PasswordGeneratorFactory(this);
        }
    }
